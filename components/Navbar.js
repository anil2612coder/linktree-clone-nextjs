...
const Navbar = () => {
  return (
    <header className="bg-white py-4 border-b ">
      ...
      <Link className=" text-center   sm:h-7 sm:w-32 h-5 w-24 relative sm:top-0 top-1  font-serif" href={"/"}><Image src={"/images/logo-2.png"} alt="logo" fill={true}/></Link>
       <nav className="flex gap-2 sm:gap-5 font-semibold items-center font-sans text-gray-400">
